...
class PredictionDto extends DtoBase {
	...
	public function __construct($record) {
				...
				$this->date_start = date('Y-m-d', strtotime($record->date_start));
				$this->date_end = date('Y-m-d', strtotime($record->date_end));
				...
				$questions =  \App\Lib\Queries\Admin\GetPrediction::GetQuestions($record->prediction_id);
				if(!empty($questions)){
