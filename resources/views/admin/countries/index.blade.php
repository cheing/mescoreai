      ...
      <div class="card-header header-sm">
        <div class="d-flex align-items-center">
          ...
          <div class="wrapper ml-auto action-bar">
            <a href="{{route('countries.create')}}" class="btn btn-success btn-block"><i class="fa fa-plus"></i> New
              Country</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form method="GET" action="{{url('admin/countries')}}" style="width:100%">
        ...
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="{{ url('admin/countries/' . $country->id . '/edit') }}"
                    class="btn btn-icons btn-success btn-action"><i class="fa fa-pencil"></i></a>
                  <button type="button" class="btn btn-icons btn-danger  btn-delete" data-id="{{$country->id}}"><i
