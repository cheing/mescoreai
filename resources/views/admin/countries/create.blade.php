...
<div class="row">
  <div class="col-lg-12 col-sm-12 grid-margin">
    <!-- form -->
    <form method="post" id="form-country" action="{{url('admin/countries')}}" enctype="multipart/form-data"
      class="forms-sample">
      @csrf
          ...
          <div class="d-flex ">
            ...
            <div class="wrapper ml-auto action-bar">
              ...
              <a class="btn btn-icons btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top"
                data-original-title="Back" href="{{route('countries.index')}}"><i class="fa fa-close"></i></a>
            </div>
          </div>
        </div>
        <!--//card-header-->
