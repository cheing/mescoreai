    ...
    <div class="card-header header-sm">
      <div class="d-flex align-items-center">
        ...
        <div class="wrapper ml-auto action-bar">
            <a href="{{route('members.create')}}" class="btn btn-success btn-block"><i class="fa fa-plus"></i> New Member</a>
        </div>
      </div>
    </div>
    <div class="card-body">
            ...
            <table class="table table-striped">
              <thead>
                <tr >
                  ...
                  <th>@sortablelink('code', 'Username')</th>
              ...
              <tbody>
                ...
                <tr>
                <td> 
                      <a href="{{ url('admin/members/' . $member->id . '/edit') }}" class="btn btn-icons btn-success btn-action"><i class="fa fa-pencil"></i></a>
                      <button type="button" class="btn btn-icons btn-danger  btn-delete" data-id="{{$member->id}}"><i class="fa fa-trash"></i></button>
                  </td>
