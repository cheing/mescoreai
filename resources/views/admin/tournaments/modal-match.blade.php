        ...
        <form method="post" id="form-match" action="{{url('admin/matches')}}">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <div class="input-group ">
                    <input id="start_time" type="text" class="form-control datetimepicker" name="start_time"
                      placeholder="" value="" />
              ...
              <div class="form-group row">
                <label class="col-md-3 col-form-label" for="team_a_result">Result Team A </label>
                <div class="col-md-3">
                  <input type="text" class="form-control" name="team_a_result" id="team_a_result" />
                </div>
                <label class="col-md-3 col-form-label" for="team_b_result">Result Team B </label>
                <div class="col-md-3">
                  <input type="text" class="form-control" name="team_b_result" id="team_b_result" />
                </div>
                <!--//col-->
              </div>
