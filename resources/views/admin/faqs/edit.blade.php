...
<div class="row">
  <div class="col-lg-12 col-sm-12 grid-margin">
    <!-- form -->
    <form method="post" id="form-faq" action="{{ url('admin/faqs/' . $faq->id) }}" enctype="multipart/form-data"
      class="forms-sample">
      ...
      <div class="card">
          ...
          <div class="d-flex ">
            ...
            <div class="wrapper ml-auto action-bar">
              ...
              <a class="btn btn-icons btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top"
                data-original-title="Back" href="{{route('faqs.index')}}"><i class="fa fa-close"></i></a>
            </div>
          </div>
        </div>
        <!--//card-header-->
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-md-3">
              <input type="text" class="form-control" name="sort" placeholder="" required value="{{ $faq->sort }}" />
            </div>
            <!--//col-->
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-12">
              ...
              <div class="input-group mb-1">
                ...
                <textarea name="title_zh" id="title_zh" class="form-control" rows="3">{{$faq->title_zh}}</textarea>
              </div>
            </div>
            <!--//col-->
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-12">
              <div class="input-group mb-1">
                ...
                <textarea name="content" id="content" class="form-control" rows="5">{{$faq->content}}</textarea>
              </div>
              <div class="input-group mb-1">
                <div class="input-group-prepend">
                  <span class="input-group-text"><span class="flag-icon flag-icon-cn"></span></span>
                </div>
                <textarea name="content_zh" id="content_zh" class="form-control"
                  rows="5">{{$faq->content_zh}}</textarea>
              </div>
            </div>
            <!--//col-->
          </div>
